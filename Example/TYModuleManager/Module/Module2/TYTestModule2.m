...
@interface TYTestModule2 () <TYModuleTabRegisterProtocol, TYModuleRouteRegisterProtocol>

@end

@implementation TYTestModule2
...
- (NSArray<TYTabItemAttribute *> *)registModuleTabItems {
    ...
    UIImage *normalImage = [[UIImage imageNamed:@"TuyaTabIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysTemplate];
    UIImage *selectImage = [[UIImage imageNamed:@"TuyaTabIcon"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
